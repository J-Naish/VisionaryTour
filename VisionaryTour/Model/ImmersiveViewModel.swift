...
class ImmersiveViewModel {
    ...
    var placeInfoList: [PlaceInfo] = [
        PlaceInfo(name: "Shibuya", locationCoordinate: CLLocationCoordinate2DMake(35.6596165, 139.7001669), panoId: "9kHHdwiEoMf1sAl6kl42og"),
        PlaceInfo(name: "Akihabara", locationCoordinate: CLLocationCoordinate2DMake(35.6987049, 139.7714407), panoId: "zmoeN2rL8CvqQZhv6saqjQ"),
        PlaceInfo(name: "Kabuki-cho", locationCoordinate: CLLocationCoordinate2DMake(35.6937649, 139.7009477), panoId: "Ptygj8IqKftSyIXv4thWpg"),
    ]
